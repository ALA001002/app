<template>
  ...
  <div class="flex1-auto flex-column">
    ...
    <ScrollMore class="section flex1 py-0" method="post" :paramsLoad="true" api="product/productOrderList" :params="params">
...
export default {
  ...
  filters: {
    date: function (value) {
      return value ? (value.split(' ').length>1?(value.split(' ')[0]+'\r\n'+value.split(' ')[1]):value.split(' ')[0]) : ''
    },
  },
  data() {
    return {
