    ...
    <div class="section">
      <van-form @submit="onSubmit">
        ...
        <div class="has-background-white panel">
          <van-field v-model.trim="form.toAddress" :label="$t('wallet.address')" :placeholder="$t('wallet.enterAddress')">
            <template #right-icon>
...
export default {
  ...
  computed: {
    ...
    fee() {
      ...
      return this.toNumber(fee > this.data.fixed ? fee : this.data.fixed)
    }
  },
  watch: {
    coin: {
