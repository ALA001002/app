    ...
    this.$http.api.get('luck/jackpotList').then(data => {
      this.awards = data.data.map(item => {
        const imgs = {
          ...
          'BTC': 'https://ppb-service.oss-eu-west-1.aliyuncs.com/BTC.png',
          'USDT': 'https://ppb-service.oss-eu-west-1.aliyuncs.com/USDT.png',
          'ETH': 'https://ppb-service.oss-eu-west-1.aliyuncs.com/ETH.png',
          'PPB': 'https://ppb-service.oss-eu-west-1.aliyuncs.com/PPB.png'
